						...
						<div className="col-md-3 col-xs-6">
							<div className="footer">
								...
								<ul className="footer-links">
									<li><a href="#"><i className="fa fa-map-marker"></i>So 1 VNN, Linh Chieu, Thu Duc</a></li>
									<li><a href="#"><i className="fa fa-phone"></i>+84 944 372 456</a></li>
									<li><a href="#"><i className="fa fa-envelope-o"></i>nguyenlongchau@gmail.com</a></li>
								</ul>
							</div>
						</div>
